export default {
    install (Vue, options) {
        Vue.prototype.$showDialog = (level, subject, verb, callback, multiple = false) => {
            Vue.prototype.$modal.show('dialogModal', {
                title: level === 'warning' ? 'Caution!' : 'Info',
                text: multiple ? `Are you sure you want to ${verb} all of these ${subject}?` : `Are you sure you want to ${verb} this ${subject}?`,
                buttons: [
                    {
