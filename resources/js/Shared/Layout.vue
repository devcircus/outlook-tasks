<template>
    <div>
        ...
        <div class="flex flex-col bg-white md:flex-row w-full">
            <div class="hidden md:block w-full md:w-1/3 lg:w-1/4 xl:w-1/6 bg-white md:px-4 md:pt-4">
                <sidebar class="sticky top-180" />
            </div>
            <div class="overflow-hidden bg-white md:bg-direction-blue w-full md:w-2/3 lg:w-3/4 xl:w-5/6 md:px-4 mt-180p">
                <slot />
            </div>
        </div>
        <site-footer />
